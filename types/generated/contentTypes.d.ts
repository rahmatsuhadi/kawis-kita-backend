...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    follow: Schema.Attribute.Relation<'manyToOne', 'api::follow.follow'>;
...
export interface ApiCommentComment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    replys: Schema.Attribute.Relation<'oneToMany', 'api::comment.comment'>;
    reply: Schema.Attribute.Relation<'manyToOne', 'api::comment.comment'>;
    follow: Schema.Attribute.Relation<'manyToOne', 'api::follow.follow'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFollowFollow extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    followers: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    followings: Schema.Attribute.Relation<'oneToMany', 'api::comment.comment'>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
